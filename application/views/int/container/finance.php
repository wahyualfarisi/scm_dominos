<!-- ============================================================== -->
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    ...
                                    <li role="separator" class="divider"></li>
                                    <li><a id="logout"><i class="fa fa-power-off"></i> Logout</a></li>
                                </ul>
                            </div>
                        </li>
                    </ul>
    ...
    <script>
        $.getScript('<?= base_url() ?>assets/internal/js/custom.min.js');
        $.getScript('<?= base_url() ?>source/int/container.js');
        $.getScript('<?= base_url() ?>source/int/main.js');
        $.getScript('<?= base_url() ?>source/int/user.js');
        $.getScript('<?= base_url() ?>source/int/supplier.js');
        $.getScript('<?= base_url() ?>source/int/warehouse.js');
    </script>
